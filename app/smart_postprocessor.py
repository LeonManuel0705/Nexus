...
try:
    ...
    ACADEMIC_VOCABULARY = {}
    PHRASE_CORRECTIONS = {}
    apply_phrase_corrections = lambda x: x
...
try:
    ...
    correct_with_learning = lambda x, c="": x
...
SEMANTIC_OUTLIER_THRESHOLD = 0.15
PHONETIC_SIMILARITY_THRESHOLD = 0.80
MIN_WORD_LENGTH_FOR_ANALYSIS = 4
CONTEXT_WINDOW_SIZE = 50
MIN_REPLACEMENT_CONFIDENCE = 0.90
ONLY_REPLACE_KNOWN_ERRORS = True
